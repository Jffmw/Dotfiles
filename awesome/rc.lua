...
-- {{{ Personal keybindings
  ...
  awful.key({ modkey }, "x", function() awful.util.spawn("betterlockscreen -l dim -- --time-str='%H:%M'") end,
    { description = "lockscreen", group = "hotkeys" }),
  awful.key({ modkey, "Shift" }, "x", function() awful.util.spawn("archlinux-logout") end,
